/*
  ...
  - You are about to drop the column `mosaic_name` on the `PhotoMosaic` table. All the data in the column will be lost.
  - Added the required column `event_name` to the `PhotoMosaic` table without a default value. This is not possible if the table is not empty.
